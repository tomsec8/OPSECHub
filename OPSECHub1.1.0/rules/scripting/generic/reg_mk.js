...
const lowlyGeneric = new Map([[33536,"#kae_unique_id_0"],[31619,".adsbygoogle"]]);
const highlyGeneric = "[href^=\"https://d.linker.mk/link\"]";
const exceptions = [".ad-placement"];
const hostnames = ["stream.mk"];
