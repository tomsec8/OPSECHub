...
const lowlyGeneric = new Map([[9831,".article-share"],[63225,".article-share__item"]]);
const highlyGeneric = "A[href*=\"http://pay4results24.eu\"],\niframe[src*=\"cherrystatic.net\"],\niframe[src*=\"date.elu24.ee\"],\nIFRAME[src*=\"sale24.ee\"],\niframe[src*=\"static.chilli.ee\"],\niframe[src*=\"superdeal.ee\"],\niframe[src*=\"hotelliveeb.ee\"]";
const exceptions = [".article-share\n.article-share__item","iframe[src*=\"hotelliveeb.ee\"]"];
const hostnames = ["postimees.ee","hotelliveeb.ee"];
