...
const lowlyGeneric = new Map([[3037,".baneriai"],[62301,".reklamos_nuorodos"],[50763,".reklamos_tarpas"],[65048,".top_reklama"]]);
const highlyGeneric = "img[alt=\"Dedikuoti.lt serveriai\"],\nimg[alt=\"Hostingas Serveriai.lt\"],\nimg[alt=\"Reklaminis skydelis\"]";
const exceptions = [];
const hostnames = [];
