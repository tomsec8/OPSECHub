...
const lowlyGeneric = new Map([[35711,"#HiddenMovie > [src^=\"http://www.youtube.com\"] + #video-blocker"],[14271,".entry > .entry-inner > .wpvl.wpvl-youtube.ng-scope.size-l"],[3031,".wpvl.wpvl-dailymotion > .fblogin.lockoverlay.ng-scope,\n.wpvl.wpvl-youtube.ng-scope.size-xl > .ng-scope + .fblogin.lockoverlay.ng-scope,\n.wpvl.wpvl-youtube.ng-scope.size-xxl > [ng-show=\"!blocked\"] + * + .ng-scope + .fblogin.lockoverlay.ng-scope"]]);
const highlyGeneric = "";
const exceptions = [".ad-link","#taboola-below-article-thumbnails\n.share-zone",".small-ad",".addtitle",".banner-300",".pub-container",".header-ad",".adclass\n.shareBtn",".cookieAlert",".adunit","#taboola-below-article-thumbnails\n.share-zone","#printads\n.adlist\n.adpic","#AdTop","#findABroker\n.generalOverlay",".postad",".ad-body","#topAds","#gnb",".image-advertisement"];
const hostnames = ["ad.co.il","c14.co.il","adi.gov.il","blms.co.il","leyada.net","masa.co.il","pitria.com","ynet.co.il","bezeq.co.il","kikar.co.il","now14.co.il","bipbip.co.il","callil.co.il","investing.com","homeless.co.il","junkyard.co.il","lavender.co.il","davidson.org.il","holmesplace.co.il"];
